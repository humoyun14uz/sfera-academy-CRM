...
const seed = {
  students: [
    { id: 'stu-001', name: 'Azizbek Karimov', phone: '+998 90 123 45 67', email: 'azizbek@example.com', course: 'Frontend Development', groupId: 'grp-fr02', teacher: 'Temurbek', status: 'active' as const, progress: 68, attendance: 92, averageGrade: 86, totalPaid: 2550000, debt: 450000 },
    { id: 'stu-002', name: 'Madina Aliyeva', phone: '+998 91 222 33 44', email: 'madina@example.com', course: 'Python Backend', groupId: 'grp-py01', teacher: 'Golib Abduhalil', status: 'active' as const, progress: 54, attendance: 84, averageGrade: 79, totalPaid: 1700000, debt: 0 },
    { id: 'stu-003', name: 'Javohir Rasulov', phone: '+998 93 333 44 55', email: 'javohir@example.com', course: 'React.js', groupId: 'grp-fr02', teacher: 'Temurbek', status: 'active' as const, progress: 41, attendance: 63, averageGrade: 72, totalPaid: 850000, debt: 850000 },
    { id: 'stu-004', name: 'Shahnoza Ergasheva', phone: '+998 95 444 55 66', email: 'shahnoza@example.com', course: 'Frontend Development', groupId: 'grp-fr02', teacher: 'Temurbek', status: 'active' as const, progress: 73, attendance: 68, averageGrade: 81, totalPaid: 2100000, debt: 350000 },
  ],
  groups: [
    { id: 'grp-fr02', name: 'FR-02', course: 'Frontend Development', teacher: 'Temurbek', room: '204', capacity: 20, studentIds: ['stu-001', 'stu-003', 'stu-004'], schedule: 'Du-Chor-Ju · 18:00', attendance: 88 },
...
const persist = (state: typeof seed) => { if (typeof window !== 'undefined') localStorage.setItem(STORAGE_KEY, JSON.stringify(state)) }
