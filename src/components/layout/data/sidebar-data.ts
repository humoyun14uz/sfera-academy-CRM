...
export const sidebarData: SidebarData = {
  ...
  teams: [
    { name: 'Sfera IT Academy', logo: LayoutDashboard, plan: 'Super Admin' },
  ],
  navGroups: [
    {
      title: 'Academy',
      items: [
        ...
        },
        {
          ...
          icon: CalendarDays,
          permission: 'groups.manage_schedule',
        },
        {
          title: 'Davomat',
          url: '/academy/attendance',
          icon: CheckCircle2,
          permission: 'students.read',
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          url: '/student/my-group',
          icon: UsersRound,
          permission: 'students.read',
        },
        {
          title: 'Jadvalim',
          url: '/student/my-schedule',
          icon: CalendarDays,
          permission: 'students.read',
        },
        {
