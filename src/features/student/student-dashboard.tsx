  ...
  return (
    <>
      ...
      <Main className='space-y-6'>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-2 border-b'>
          <div className='space-y-1'>
            ...
            <p className='text-xs sm:text-sm text-muted-foreground flex items-center gap-2'>
              <span>{label('Frontend dasturlash', 'Frontend development')}</span>
              <span>•</span>
        ...
        {/* 4 Asosiy Metrika Kartochkalari */}
        <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
          <Card className='shadow-sm hover:shadow-md transition-shadow'>
            ...
            <CardContent className='space-y-2'>
              ...
              <Progress value={87.5} className='h-2 [&>div]:bg-green-500' />
              <p className='text-xs text-muted-foreground flex items-center justify-between'>
                <span>{label('48 darsdan 42 tasida qatnashgan', 'Attended 42 of 48 classes')}</span>
          ...
          <Card className='shadow-sm hover:shadow-md transition-shadow'>
            ...
            <CardContent className='space-y-2'>
              ...
              <p className='text-xs text-muted-foreground flex items-center justify-between'>
                ...
                <span className='font-medium text-blue-600 dark:text-blue-400'>{label('Eng yaxshi 5%', 'Top 5%')}</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='shadow-sm hover:shadow-md transition-shadow'>
            ...
            <CardContent className='space-y-2'>
              ...
              <Progress value={(14/16)*100} className='h-2 [&>div]:bg-amber-500' />
              <p className='text-xs text-muted-foreground flex items-center justify-between'>
                <span>{label('1 ta tekshiruvda, 1 ta yangi', '1 under review, 1 new')}</span>
                <span className='font-medium text-amber-600 dark:text-amber-400'>87.5%</span>
              </p>
            </CardContent>
          </Card>
          ...
          <Card className='shadow-sm hover:shadow-md transition-shadow'>
            ...
            <CardContent className='space-y-2'>
              <div className='text-2xl font-bold'>5 / 6 {label('oy', 'months')}</div>
              <Progress value={(5/6)*100} className='h-2 [&>div]:bg-purple-500' />
              <p className='text-xs text-muted-foreground flex items-center justify-between'>
                <span>{label('Qoldiq: 1 200 000 UZS', 'Balance: 1,200,000 UZS')}</span>
        ...
        <Tabs defaultValue='overview' className='space-y-4'>
          ...
          <TabsContent value='overview' className='space-y-4'>
            <div className='grid gap-4 lg:grid-cols-7'>
              {/* Chap katta blok: Faollik grafigi */}
              ...
              {/* O'ng blok: Bugungi dars va ustoz */}
